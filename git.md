...
This is a Git Style Guide inspired by Agis Anastasopoulos / [@agisanast](https://twitter.com/agisanast) / http://agis.io
...
* Each commit should be a single *logical change*. Don't make several
  ...
  *Pro Tip: Use `git add -p` to interactively stage specific portions of the
  modified files.*
